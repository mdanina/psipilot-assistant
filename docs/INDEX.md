...
- **029_user_session_tabs.sql** - Таблица для хранения открытых вкладок сессий
  - **[docs/SESSION_TABS_PERSISTENCE.md](SESSION_TABS_PERSISTENCE.md)** - Документация персистентности вкладок
...
### Управление вкладками сессий
- **[docs/SESSION_TABS_PERSISTENCE.md](SESSION_TABS_PERSISTENCE.md)** - Документация персистентности открытых вкладок сессий
  - Миграция: `029_user_session_tabs.sql`
  - Хранение состояния открытых вкладок в БД
  - Обработка навигации из карточки пациента
